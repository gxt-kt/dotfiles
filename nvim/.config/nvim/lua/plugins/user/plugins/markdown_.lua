...
local markdown_highlight_method = require("my_sys").GetConfig("config_", "markdown.highlight_method", "headlines")
...
return {
  ...
  },
  {
    ...
    enabled = (markdown_highlight_method == "headlines"),
    ft = "markdown",
  ...
  },
  {
    ...
    enabled = (markdown_highlight_method == "render-markdown"),
